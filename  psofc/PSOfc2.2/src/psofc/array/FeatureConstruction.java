...
//        System.out.println();
        ...
        if (sum != 0) {
            ...
            char[] operators = new char[(position.size() - 1) / 2];  // temperory, this need to according the results of the selected operators

            operators = OperatorSelection.getOpFromArray(position);
